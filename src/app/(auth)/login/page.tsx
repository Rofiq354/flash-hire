...
import { ErrorCleaner } from "./ErrorCleaner";
...
export default function LoginPage({
  ...
  const loginForm = (
    <div className="space-y-8">
      ...
      {errorMessage && (
        <div className="flex items-center gap-2 rounded-xl border border-red-200 bg-red-50 p-4 text-sm text-red-600 animate-in fade-in slide-in-from-top-1">
